...
/**
*
* \brief implements the sending process
*
...
int main(int argc, char * const * argv)
{
    ...
    /* Shared Memory im Schreibmodus (0) einbinden */
    if ((shmaddr = attach_shm(shmid, 0)) == (int *) -1)
	  {
		clear_sem(semidr, semidw);      /* im Fehlerfall Semaphore löschen*/
    ...
    if (send_data(semidr, semidw, shmaddr, shmsize) == -1)  
	  {
    ...
    /* Shared Memory loslassen */
    clear_attshm(shmaddr);
